...
public class InMemDaoImpl implements Dao<MemorySegment, Entry<MemorySegment>> {
    ConcurrentSkipListMap<MemorySegment, Entry<MemorySegment>> storage = new ConcurrentSkipListMap<>((o1, o2) -> Arrays.compare(o1.toArray(ValueLayout.JAVA_BYTE), o2.toArray(ValueLayout.JAVA_BYTE)));
    @Override
